...
# 13. Даны три вещественных числа a, b, c.
...
# 14. Правильный многоугольник — выпуклый многоугольник, у которого равны все стороны и все углы между смежными сторонами.
...
# 15. Напишите программу определяющую евклидово расстояние между двумя точками, координаты которых заданы.
...
sum_of_deltas = pow(delta_x, 2) + pow(delta_y, 2)
euclidean_distance = sqrt(sum_of_deltas)
print(euclidean_distance)


# 16. Напишите программу, вычисляющее значение ⌈x⌉ +⌊x⌋ по заданному вещественному числу x.
